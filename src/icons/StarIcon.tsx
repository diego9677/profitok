export const StarIcon = ({ width, height, color, className }: { width: number, height: number; color?: string; className?: string; }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} color={color} className={className} viewBox="0 0 36 36">
